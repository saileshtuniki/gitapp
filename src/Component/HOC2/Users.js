        ...
        return (
            <div className='container'>
                ...
                <div className="row">
                    <div className="col">
                        <h2>User details</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis voluptates dolore unde nihil quis quisquam fugit illo corporis ab consequuntur.</p>
                ...
                <div className="row">
                    <div className="col-2">
                        <input type="radio" value="all" name="gender" className='mx-1' onChange={()=>{this.props.filterdata("all")}}/>
                        ALL
                    </div>
                    <div className="col-2">
